...
<section class="header">
    ...
    <h1 class="heading-title">{{$exc->title}}</h1>
        <div class="box-container">
        <div class="image">
            <div class="box">
                <img src="{{ asset('images/' . $exc->image1) }}" alt="" width="100%" height="100%" >
                </div>
            </div>
            <div class="image">
            <div class="box">
                <img src="{{ asset('images/' . $exc->image2) }}" alt=""  width="100%" height="0%">
                </div>
            </div>
            <div class="image">
            <div class="box">
                <img src="{{ asset('images/' . $exc->image3) }}" alt="12" width="620px"height="500px">
                </div>
            </div>
            <div class="image">
                <div class="box">
            ...
            <livewire:calendar :idCalendar="$exc->id" />
