...
<body>
    ...
    <section class="header">
        <a href="{{route('welcome')}}" class="logo"><img src="./images/images (4).jpg" class="img-responsive" alt="" width="150px" height="50px"></a>
    ...
    <section class="home-packages"id="con">
       ...
       @foreach($homes as $home)
          <div class="box">
                <div class="image">
                    <img  src="{{ asset('images/' . $home->image) }}" alt="">
                </div>
                <div class="content">
                    <h3>{{$home->title}}</h3>
                    <p>{{$home->BLOB}}</p>
...
<a href="{{route('hotels')}}" class="btn">   Affiche Tout</a></div>
    </section>
    <section class="home-packages"id="con">
        ...
        <div class="d-flex center"></div>
            <a href="{{route('excursion')}}" class="btn">   Affiche Tout</a></div>
    </div>
